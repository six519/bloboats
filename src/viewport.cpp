...
int main(int argc, char*argv[]) {
	...
	if (!SDL_SetVideoMode(800, 600, 32, SDL_OPENGL) ) warn("Couldn't open OpenGL screen.\n");
...
#ifdef __APPLE__
	glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA8, s->w, s->h, 0, GL_BGRA, GL_UNSIGNED_INT_8_8_8_8, s->pixels);
#else
